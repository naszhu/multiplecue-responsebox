# ACC / RT summaries by subject (incl. speed-accuracy tradeoff).
# Reads trial CSVs from exp/data_from_lab/sub{N}/ only.
#
# Run from multiplecue-responsebox/ or analysis/:
#   Rscript analysis/plot_acc_rt_by_subject.R
#   Rscript plot_acc_rt_by_subject.R
...
setting_tag <- paste0(
  "sub", min(subject_ids), "-", max(subject_ids),
  "_ses", min(session_ids), "-", max(session_ids)
)
n_subj_plot <- length(subject_ids)
facet_height_all <- max(14, 3.2 * ceiling(n_subj_plot / 2))
...
read_trial_csv <- function(path) {
  ...
  needed <- c(
    ...
    "Cues", "CueRanks", "TrialWallClockTime"
  )
  for (col in needed) {
...
# Prefer CueCondition (current lab format: "(4,2)"); fall back to CueValues.
get_condition <- function(cue_condition, cue_values_string) {
...
plot_df <- combined_df %>%
  ...
  filter(
    SubjectNum %in% subject_ids,
    SessionNumInt %in% session_ids,
  ...
  mutate(
    SubjectNum = factor(SubjectNum, levels = subject_ids),
    SessionNum = factor(SessionNumInt, levels = session_ids),
...
rt_qcond_file <- file.path(fig_dir, paste0(setting_tag, "_RTQCond_AllDev.png"))
...
rt_diff_all_file <- file.path(fig_dir, paste0(setting_tag, "_RTRewardDiff_AllDev.png"))
ggsave(filename = rt_diff_all_file, plot = rt_diff_plot_all + bold_axes_theme, width = 20, height = facet_height_all, dpi = 300)
...
acc_diff_all_file <- file.path(fig_dir, paste0(setting_tag, "_ACCRewardDiff_AllDev.png"))
ggsave(filename = acc_diff_all_file, plot = acc_diff_plot_all + bold_axes_theme, width = 20, height = facet_height_all, dpi = 300)
...
rt_cond_all_file <- file.path(fig_dir, paste0(setting_tag, "_RTCondVln_AllDev.png"))
ggsave(filename = rt_cond_all_file, plot = rt_cond_plot_all + bold_axes_theme, width = 20, height = facet_height_all, dpi = 300)
...
acc_cond_all_file <- file.path(fig_dir, paste0(setting_tag, "_ACCCond_AllDev.png"))
ggsave(filename = acc_cond_all_file, plot = acc_cond_plot_all + bold_axes_theme, width = 20, height = facet_height_all, dpi = 300)
...
rt_day_all_file <- file.path(fig_dir, paste0(setting_tag, "_RTDayVln_AllDev.png"))
ggsave(filename = rt_day_all_file, plot = rt_day_plot_all + bold_axes_theme, width = 20, height = facet_height_all, dpi = 300)
...
acc_day_all_file <- file.path(fig_dir, paste0(setting_tag, "_ACCDay_AllDev.png"))
ggsave(filename = acc_day_all_file, plot = acc_day_plot_all + bold_axes_theme, width = 20, height = facet_height_all, dpi = 300)
...
rt_session_all_file <- file.path(fig_dir, paste0(setting_tag, "_RTSessionVln_AllDev.png"))
ggsave(filename = rt_session_all_file, plot = rt_session_plot_all + bold_axes_theme, width = 20, height = facet_height_all, dpi = 300)
...
acc_session_all_file <- file.path(fig_dir, paste0(setting_tag, "_ACCSession_AllDev.png"))
ggsave(filename = acc_session_all_file, plot = acc_session_plot_all + bold_axes_theme, width = 20, height = facet_height_all, dpi = 300)
...
rt_key_all_file <- file.path(fig_dir, paste0(setting_tag, "_RTKey_AllDev.png"))
ggsave(filename = rt_key_all_file, plot = rt_key_plot_all + bold_axes_theme, width = 20, height = facet_height_all, dpi = 300)
...
acc_key_all_file <- file.path(fig_dir, paste0(setting_tag, "_ACCKey_AllDev.png"))
ggsave(filename = acc_key_all_file, plot = acc_key_plot_all + bold_axes_theme, width = 20, height = facet_height_all, dpi = 300)
...
rt_key_g2_all_file <- file.path(fig_dir, paste0(setting_tag, "_RTKey_G2_AllDev.png"))
ggsave(filename = rt_key_g2_all_file, plot = rt_key_g2_plot_all + bold_axes_theme, width = 20, height = facet_height_all, dpi = 300)
...
acc_key_g2_all_file <- file.path(fig_dir, paste0(setting_tag, "_ACCKey_G2_AllDev.png"))
ggsave(filename = acc_key_g2_all_file, plot = acc_key_g2_plot_all + bold_axes_theme, width = 20, height = facet_height_all, dpi = 300)
...
rt_color_all_file <- file.path(fig_dir, paste0(setting_tag, "_RTTopColor_AllDev.png"))
ggsave(filename = rt_color_all_file, plot = rt_color_plot_all + bold_axes_theme, width = 20, height = facet_height_all, dpi = 300)
...
acc_color_all_file <- file.path(fig_dir, paste0(setting_tag, "_ACCTopColor_AllDev.png"))
ggsave(filename = acc_color_all_file, plot = acc_color_plot_all + bold_axes_theme, width = 20, height = facet_height_all, dpi = 300)
...
rt_color_g2_all_file <- file.path(fig_dir, paste0(setting_tag, "_RTTopColor_G2_AllDev.png"))
ggsave(filename = rt_color_g2_all_file, plot = rt_color_g2_plot_all + bold_axes_theme, width = 20, height = facet_height_all, dpi = 300)
...
acc_color_g2_all_file <- file.path(fig_dir, paste0(setting_tag, "_ACCTopColor_G2_AllDev.png"))
ggsave(filename = acc_color_g2_all_file, plot = acc_color_g2_plot_all + bold_axes_theme, width = 20, height = facet_height_all, dpi = 300)
...
tradeoff_plot_all <- ggplot(tradeoff_df, aes(x = MeanRT, y = Accuracy, group = 1)) +
  ...
  facet_wrap(~SubjectFacet, ncol = 2, scales = "fixed") +
  labs(
    title = paste0("Speed-Accuracy Tradeoff by Condition (", setting_tag, ")"),
...
tradeoff_all_file <- file.path(fig_dir, paste0(setting_tag, "_SpeedAccuracyTradeoff_AllDev.png"))
ggsave(filename = tradeoff_all_file, plot = tradeoff_plot_all + bold_axes_theme, width = 20, height = facet_height_all, dpi = 300)
...
tradeoff_plot_relative_all <- ggplot(tradeoff_df, aes(x = MeanRT, y = Accuracy, group = 1)) +
  ...
  labs(
    title = paste0("Speed-Accuracy Tradeoff by Condition (Relative Scales; ", setting_tag, ")"),
...
tradeoff_relative_all_file <- file.path(fig_dir, paste0(setting_tag, "_SpeedAccuracyTradeoff_RelativeScale_AllDev.png"))
ggsave(filename = tradeoff_relative_all_file, plot = tradeoff_plot_relative_all + bold_axes_theme, width = 20, height = facet_height_all, dpi = 300)
...
tradeoff_qcount_all_file <- file.path(fig_dir, paste0(setting_tag, "_SpeedAccuracyTradeoff_QCount_AllDev.png"))
ggsave(filename = tradeoff_qcount_all_file, plot = tradeoff_qcount_plot_all + bold_axes_theme, width = 20, height = facet_height_all, dpi = 300)
...
caf_all_file <- file.path(fig_dir, paste0(setting_tag, "_CAF_AllDev.png"))
ggsave(filename = caf_all_file, plot = caf_plot_all + bold_axes_theme, width = 20, height = facet_height_all, dpi = 300)
...
interference_rt_file <- file.path(fig_dir, paste0(setting_tag, "_InterferenceRTHeatmap_AllDev.png"))
ggsave(filename = interference_rt_file, plot = interference_rt_plot + bold_axes_theme, width = 20, height = facet_height_all, dpi = 300)
...
interference_acc_file <- file.path(fig_dir, paste0(setting_tag, "_InterferenceACCHeatmap_AllDev.png"))
ggsave(filename = interference_acc_file, plot = interference_acc_plot + bold_axes_theme, width = 20, height = facet_height_all, dpi = 300)
...
rtdiff_session_file <- file.path(fig_dir, paste0(setting_tag, "_RTDiffTrendSession_NoKB.png"))
ggsave(filename = rtdiff_session_file, plot = rtdiff_session_plot + bold_axes_theme, width = 20, height = facet_height_all, dpi = 300)
...
rtdiff_day_file <- file.path(fig_dir, paste0(setting_tag, "_RTDiffTrendDay_NoKB.png"))
ggsave(filename = rtdiff_day_file, plot = rtdiff_day_plot + bold_axes_theme, width = 20, height = facet_height_all, dpi = 300)
...
rtdiff_trial_file <- file.path(fig_dir, paste0(setting_tag, "_RTDiffTrendTrial_NoKB.png"))
ggsave(filename = rtdiff_trial_file, plot = rtdiff_trial_plot + bold_axes_theme, width = 20, height = facet_height_all, dpi = 300)
...
rt_sesday_all_file <- file.path(fig_dir, paste0(setting_tag, "_RTSesDayVln_AllDev.png"))
...
acc_sesday_all_file <- file.path(fig_dir, paste0(setting_tag, "_ACCSesDay_AllDev.png"))
